...
/**
 * Class generated from <tt>gradys_simulations/linklayer/blemesh/BleMeshMacHeader.msg:34</tt> by opp_msgtool.
 * <pre>
 * //
...
class BleMeshMacHeader : public ::inet::FieldsChunk
{
  ...
  protected:
    bool operator==(const BleMeshMacHeader&) = delete;
...
template<> inline inet::BleMeshMacHeader *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::BleMeshMacHeader*>(ptr.get<cObject>()); }
