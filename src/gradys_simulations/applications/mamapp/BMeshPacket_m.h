...
/**
 * Class generated from <tt>gradys_simulations/applications/mamapp/BMeshPacket.msg:12</tt> by opp_msgtool.
 * <pre>
 * //
...
class BMeshPacket : public ::inet::FieldsChunk
{
  ...
  protected:
    bool operator==(const BMeshPacket&) = delete;
...
template<> inline inet::BMeshPacket *fromAnyPtr(any_ptr ptr) { return check_and_cast<inet::BMeshPacket*>(ptr.get<cObject>()); }
